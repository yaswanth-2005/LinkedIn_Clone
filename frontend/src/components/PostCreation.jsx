...
const PostCreation = ({ user }) => {
  ...
  const { mutate: postCreation, isPending } = useMutation({
    ...
    <div className="bg-secondary rounded-lg  border-2 border-gray-300 shadow-lg mb-4 p-4">
      ...
      <div className="flex justify-between items-center mt-4">
        <div className="flex space-x-4">
          <label className="flex items-center text-info hover:text-info-dark transition-colors duration-200 cursor-pointer hover:bg-gray-100 rounded-lg px-4 py-2">
